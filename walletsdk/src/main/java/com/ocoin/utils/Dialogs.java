...
import com.ocoin.interfaces.AdDialogResponseHandler;
...
public class Dialogs {
    ...
    public static void addWatchOnly(final WalletMainActivity c) {
    ...
    public static void importWallets(final WalletMainActivity c, final ArrayList<File> files) {
        String addresses = "";
