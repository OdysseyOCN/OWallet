...
public class EtherscanAPI_OLD {

    private String token;

    private static EtherscanAPI_OLD instance;

    public static EtherscanAPI_OLD getInstance() {
        if (instance == null)
            instance = new EtherscanAPI_OLD();
        return instance;
    }
