...
import com.ocoin.activities.RequestEtherActivity;
...
import com.ocoin.utils.TransactionAdapter;
...
//        }
    ...
    public void onClick(View view) {
        if (ac == null) return;
        int itemPosition = TransactionAdapter.calculateBoxPosition(recyclerView.getChildLayoutPosition(view))+1;
