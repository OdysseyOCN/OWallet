...
import com.ocoin.fragments.FragmentSend;

import rehanced.com.simpleetherwallet.R;
import com.ocoin.fragments.FragmentChooseRecipient;
import com.ocoin.views.NonSwipeViewPager;
...
//    public static final int
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("TOKEN_ADDRESS"))
            bundle.putString("TOKEN_ADDRESS", getIntent().getStringExtra("TOKEN_ADDRESS"));
        if (getIntent().hasExtra("REQUEST_UUID"))
            bundle.putString("REQUEST_UUID", getIntent().getStringExtra("REQUEST_UUID"));
