...
import com.ocoin.utils.AppLockUtils;
...
import com.ocoin.interfaces.FingerprintListener;
import com.ocoin.utils.FingerprintHelper;
...
public class AppLockActivity extends BasePatternActivity implements PatternView.OnPatternListener, FingerprintListener {
    ...
    public boolean cipherInit() {
        ...
        try {
            keyStore.load(null);
            SecretKey key = (SecretKey) keyStore.getKey("OCoin", null);
    ...
    protected void generateKey() {
        ...
        try {
            ...
            keyGenerator.init(new
                    KeyGenParameterSpec.Builder("OCoin",
